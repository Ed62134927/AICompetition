...
class AspectBasedSentimentAnalyzer:
    ...
    def __init__(self, model_name='ckiplab/bert-base-chinese'):
        ...
        self.aspects = {
            '重量體積': {
                'keywords': ['輕', '重', '薄', '厚', '小', '大', '體積', '重量', 
                           '尺寸', '便攜', '攜帶', '輕薄', '輕巧', '袖珍'],
                'positive_terms': ['輕', '薄', '小', '便攜', '輕巧', '袖珍'],
                'negative_terms': ['重', '厚', '大', '笨重', '佔空間']
            },
            '充電速度': {
                'keywords': ['快充', '慢', '快', '速度', '充電', 'PD', 'QC', 
                           '瓦數', 'W', '快速', '閃充', '急速', '充滿'],
                'positive_terms': ['快', '快速', '急速', '秒充', '閃充'],
                'negative_terms': ['慢', '龜速', '久', '等很久']
            },
            '接口相容性': {
                'keywords': ['Type-C', 'Lightning', 'USB', '接口', '孔', '線', 
                           '相容', '通用', '萬用', '多口', 'Micro USB'],
                'positive_terms': ['通用', '相容', '萬用', '多口', '齊全'],
                'negative_terms': ['不相容', '沒有', '缺少', '只有']
            },
            '外觀材質': {
                'keywords': ['外觀', '質感', '材質', '設計', '顏色', '美', 
                           '醜', '好看', '塑膠', '金屬', '鋁合金', '霧面'],
                'positive_terms': ['質感', '高級', '精緻', '好看', '美', '有質感'],
                'negative_terms': ['廉價', '醜', '塑膠感', '粗糙']
            },
            '價格': {
                'keywords': ['價格', '貴', '便宜', '值得', 'CP', '划算', 
                           '性價比', '價錢', '元', '超值', '平價'],
                'positive_terms': ['便宜', '划算', '超值', '值得', 'CP值高'],
                'negative_terms': ['貴', '昂貴', '不值', 'CP值低', '坑錢']
            }
        }
